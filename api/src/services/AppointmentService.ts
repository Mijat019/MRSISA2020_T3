...
class AppointmentService {
  ...
  public async addFreeAppointment(appointmentPayload: any) {
    ...
    return await this.getFreeAppointment(
      appointmentPayload.start,
      appointmentPayload.room.id,
      appointmentPayload.doctor.id
    );
  }
  ...
  public async updateFreeAppointment(appointmentPayload: any) {
    ...
    await FreeAppointments.update(newFreeApp, {
  ...
  public async getFreeAppointment(
    start: any,
    room: any,
    doctorId: any
  ): Promise<any> {
