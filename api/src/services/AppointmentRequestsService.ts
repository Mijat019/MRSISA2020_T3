...
class AppointmentRequestsService {
    private include = [
        {
            ...
            as: "doctor",
            required : true,
            include: [{ model: Users, as: "user", attributes: usersSelect, required: true }],
        },
        {
            model: PriceLists,
            as: "priceList",
            required : true,
            include: [{ model: AppointmentTypes, as: "appointmentType", required: true }],
        },
        {
        ...
        // { model: Users, as: "patient" , required: true},
    ];
    ...
    public async confirm(requestPayload : any):Promise<any>  {
        ...
        requestPayload.userId = requestPayload.patientMedicalRecord.userId;
